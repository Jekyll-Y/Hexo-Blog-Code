...
function createParticule(e, t) {
	var a = {};
    // 修改粒子大小
	return a.x = e, a.y = t, a.color = colors[anime.random(0, colors.length - 1)], a.radius = anime.random(6, 18), a.endPos = setParticuleDirection(a), a.draw = function() {
...
function animateParticules(e, t) {
	...
	anime.timeline().add({
		...
		targets: a,
		radius: anime.random(40, 60),	// 修改圆圈大小
		lineWidth: 0,
		alpha: {
			value: 0,
			easing: "linear",
...
if (canvasEl) {
	var ctx = canvasEl.getContext("2d"),
		...
		pointerY = 0,
		tap = "mousedown",
		colors = ["#F19EC2", "#6D77B3", "#F97E72", "#72F1B8"],
